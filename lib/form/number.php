...
require_once("HTML/QuickForm/number.php");
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class MoodleQuickForm_number extends HTML_QuickForm_number implements templatable {
     ...
     */
    public function MoodleQuickForm_number($elementName=null, $elementLabel=null, $attributes=null) {
